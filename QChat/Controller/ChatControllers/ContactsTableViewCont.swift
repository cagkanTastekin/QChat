...
// Storyboard ID & Restoration ID --> ContactsTVC
...
class ContactsTableViewCont: UITableViewController, UISearchResultsUpdating, ContactsCellDelegate  {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.generateCellWithContacts(fUser: user, indexPath: indexPath)
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            ...
            if !isGroup {
                ...
                if selected {
                    ...
                    let objectIndex = memberIdsOfGroupChat.firstIndex(of: userToChat.objectId as String)
    ...
    //MARK: IBActions
        ...
        @objc func inviteUsersButtonPressed() {
            ...
            activityViewController.setValue(NSLocalizedString("Lets chat on QChat", comment: ""), forKey: "subject")
     
            self.present(activityViewController, animated: true, completion: nil)
        }
     
        @objc func searchNearByButtonPressed() {
            let usersVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "UsersTVC") as! UsersTableViewCont
        ...
        @objc func nextButtonPressed() {
            ...
            let newGroupVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "NewGroupVC") as! NewGroupViewCont
        ...
        func compareUsers() {
            ...
            updateCurrentUserInFirestore(withValues: [kCONTACT : usersContacts]) { (error) in
                ...
                print("There are \(self.contacts.count) contacts in list")
            }
        ...
        func removeCountryCode(countryCodeLetters: String, fullPhoneNumber: String) -> String {
            ...
            do {
                ...
                // NSLog("/////formated string is [%@]", formattedString)
                // NSLog(".....phone is [%@]", phoneNumber.nationalNumber)
    ...
    func didTapAvatarImage(indexPath: IndexPath) {
        let profileVC = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "UserProfileTVC") as! UserProfileTableViewCont
